...
const spriteAnimations = {
    ...
    // Angel LilGuy animations (shares most animation frames with normal)
    angel: {
        idle: {
            frames: [
                {
    ...
    // Devil LilGuy animations (shares most animation frames with normal)
    devil: {
        idle: {
            frames: [
                {
...
const getSpriteSheetPath = (stage, color)=>{
    if (stage === 'egg') {
        ...
        return `/assets/sprites/angel.png`;
    } else if (stage === 'devil') {
        return `/assets/sprites/devil.png`;
    } else {
...
const getAnimationFrames = (stage, animation)=>{
    ...
    // Use normal animations for hatchling
    if (stage === 'hatchling') {
        return spriteAnimations.normal[animation] || spriteAnimations.normal.idle;
    }
    // Use angel animations for angel
    if (stage === 'angel') {
        return spriteAnimations.angel[animation] || spriteAnimations.angel.idle;
    }
    // Use devil animations for devil
    if (stage === 'devil') {
        return spriteAnimations.devil[animation] || spriteAnimations.devil.idle;
    }
...
const PixelLilGuy = ({ showControls = false, size = 'normal', className = '', initialAnimation = 'idle', initialStage = 'normal', initialColor = 'black', health = 50 })=>{
    // State for character
    ...
    // Determine evolution based on goals
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const checkForEvolution = ()=>{
            ...
            if (stage === 'normal') {
                const averageScore = parseFloat(getLocalStorageItem('weeklyAverage', '50'));
                if (averageScore > 80) {
                    setStage('angel');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (health < 20 && animation !== 'sad') {
            setAnimation('sad');
            setTimeout(()=>setAnimation('idle'), 1000);
        } else if (health > 80 && animation !== 'happy') {
            setAnimation('happy');
            setTimeout(()=>setAnimation('idle'), 1000);
        }
    }, [
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__60ca0187._.js.map