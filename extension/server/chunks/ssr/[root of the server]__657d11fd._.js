...
__turbopack_context__.s({
    ...
    "getColorForStage": (()=>getColorForStage),
...
const getColorForStage = (stage, defaultColor)=>{
...
;
const spriteCache = {};
// PixelLilGuy Component
const PixelLilGuy = ({ stage = 'normal', animation = 'idle', healthLevel = 100, size = 64, className = '', color = 'green', onClick, onAnimationComplete, interactive = true })=>{
    // Refs and state
    ...
    const [frameCount, setFrameCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    // Determine the correct stage based on health level
    const determineStage = ()=>{
        if (healthLevel <= 0) return 'angel';
        if (healthLevel <= 20) return 'devil';
        if (healthLevel > 90) return 'normal';
        if (healthLevel > 50) return 'hatchling';
        return 'egg';
    };
    // Use calculated stage if provided stage is 'auto'
    const actualStage = stage === 'normal' ? determineStage() : stage;
    // Determine the right color based on stage
    const actualColor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getColorForStage"])(actualStage, color);
    // Load sprite image and handle caching
    const loadSpriteImage = (src)=>{
    ...
    // Draw a fallback sprite if image loading fails
    const drawFallbackSprite = ()=>{
        const canvas = canvasRef.current;
        if (!canvas) return;
        const ctx = canvas.getContext('2d');
        if (!ctx) return;
        // Check if we should use sprite data
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shouldUseSpriteData"])()) {
            const dataUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSpriteDataUrl"])(actualColor);
            if (dataUrl) {
                const img = new Image();
                img.onload = ()=>{
                ...
                // If no data URL, draw a simple shape
                ctx.clearRect(0, 0, canvas.width, canvas.height);
                ctx.fillStyle = actualColor === 'green' ? '#4CAF50' : actualColor === 'blue' ? '#2196F3' : '#333333';
    ...
    const animateLilGuy = ()=>{
        ...
        const animationDef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteManager$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAnimationFrames"])(actualStage, animation);
        // Increment frame count for animation timing
        setFrameCount((prev)=>prev + 1);
        // Get the current animation frame based on the frame count
        const frameIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteManager$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAnimationFrameIndex"])(animation, frameCount);
        // If using fallback, just update the frame and return
        if (useFallback) {
            setCurrentFrame(frameIndex);
            requestRef.current = requestAnimationFrame(animateLilGuy);
            return;
        }
        try {
            // Calculate the current sprite path
            const spritePath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteManager$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSpriteSheetPath"])(actualStage, actualColor, animation, frameIndex);
            // Load the current frame sprite
            loadSpriteImage(spritePath).then((img)=>{
                setImageLoaded(true);
                ...
                setCurrentFrame(frameIndex);
                // Call animation complete callback at the end of animation
                if (frameIndex === animationDef.frames.length - 1 && onAnimationComplete) {
                    onAnimationComplete();
                }
            }).catch((err)=>{
                console.error(`Error loading sprite: ${spritePath}`, err);
                setUseFallback(true);
                drawFallbackSprite();
            });
    ...
    // Initialize animation when component mounts or props change
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("canvas", {
        ...
        width: size,
        height: size,
        className: `pixel-lilguy ${className}`,
        onClick: handleClick,
        style: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__657d11fd._.js.map