(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_32af1d93._.js", {
...
const PixelLilGuy = ({ showControls = false, size = 'normal', className = '', initialAnimation = 'idle', initialStage = 'normal', initialColor = 'green', health = 50 })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PixelLilGuy.useEffect": ()=>{
            ...
            // Define image paths based on stage and color
            let spritePath = '/assets/sprites/';
            if (stage === 'egg') {
                spritePath += `egg_${color}.png`;
            } else if (stage === 'hatchling') {
                spritePath += `hatchling_${color}.png`;
            } else if (stage === 'angel') {
                spritePath += 'angel.png';
            } else if (stage === 'devil') {
                spritePath += 'devil.png';
            } else {
                spritePath += `lilguy_${color}.png`;
            }
            // Create sprite animation logic
            const playerImage = new Image();
            playerImage.src = spritePath;
            // Placeholder sprite sheet dimensions - should be updated with actual sprite sheets
            const spriteWidth = 32;
            const spriteHeight = 32;
            let gameFrame = 0;
            const staggerFrames = 5;
            // Scale based on container size
            const scale = size === 'widget' ? 1 : 3;
            ...
            // This is a placeholder - actual sprite positions would depend on the sprite sheet
            ...
            function animate() {
                ...
                const frameX = spriteWidth * spriteAnimations[animation].loc[position].x;
                const frameY = spriteHeight * spriteAnimations[animation].loc[position].y;
                // Draw the sprite
...
_s(PixelLilGuy, "LDhlPZRRYJn5IapqDPuwmC4rGKI=", false, function() {
    return [
...
//# sourceMappingURL=src_32af1d93._.js.map