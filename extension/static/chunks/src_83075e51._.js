(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_83075e51._.js", {
...
"[project]/src/components/LilGuy/SpriteData.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const isBrowser = "object" !== 'undefined' && typeof document !== 'undefined';
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/LilGuy/SpriteData.ts [app-client] (ecmascript)");
...
const PixelLilGuy = ({ stage = 'normal', animation = 'idle', healthLevel = 100, size = 64, className = '', color = 'green', onClick, onAnimationComplete, interactive = true })=>{
    ...
    const actualColor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteAdapter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColorForStage"])(actualStage, color);
    ...
    const drawFallbackSprite = ()=>{
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldUseSpriteData"])()) {
            const dataUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSpriteDataUrl"])(actualColor);
            if (dataUrl) {
                const img = new Image();
                img.onload = ()=>{
                    ctx.clearRect(0, 0, canvas.width, canvas.height);
    ...
    const animateLilGuy = ()=>{
        ...
        const animationDef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAnimationFrames"])(actualStage, animation);
        // Increment frame count for animation timing
        setFrameCount((prev)=>prev + 1);
        // Get the current animation frame based on the frame count
        const frameIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAnimationFrameIndex"])(animation, frameCount);
        ...
        try {
            ...
            const spritePath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LilGuy$2f$SpriteManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSpriteSheetPath"])(actualStage, actualColor, animation, frameIndex);
...
_s(PixelLilGuy, "byZqt8AQgoUQSwPwD1nGV68ql2c=");
_c = PixelLilGuy;
...
//# sourceMappingURL=src_83075e51._.js.map